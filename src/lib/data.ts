    ...
    problem_statements: [
      {
        ...
        info: "Develop a machine learning model to predict patient outcomes based on historical health data, aiming to improve treatment plans and resource allocation in healthcare facilities.",
      },
      {
        title: "Financial Market Forecasting",
        info: "Create an AI-driven model to analyze and forecast stock market trends, helping investors make informed decisions based on predictive analytics.",
      },
    ],
  },
  {
    ...
    problem_statements: [
      {
        ...
        info: "Design and implement an advanced intrusion detection system that can identify and respond to cyber threats in real-time, enhancing the security of network infrastructures.",
      },
      {
        title: "Secure Authentication Methods",

        info: "Develop innovative authentication techniques that enhance user security while maintaining ease of access, such as biometric systems or multi-factor authentication solutions.",
      },
    ],
  },
  {
